...
Therefore we may conclude that for a web-lab experiment designed as we stated above, i.e. permutate species presence and observe steady state abundance, random forest can be used to predict the steady state of the community. 
