...
library(reticulate)
use_condaenv("CommunitySimDemo") # Need a conda env with numpy, matplotlib, and scikit-learn for Machine Learning Case Study
```
...
We carry on the rest of the study in Python.
